    ...
    <section id="stack" className="py-48 px-6 md:px-12 max-w-[1400px] mx-auto">
      ...
      >
        ...
        <motion.div
          ...
          className="md:col-span-8 bento-card flex flex-col justify-end min-h-[340px]"
        >
          <span className="text-[10px] font-bold tracking-[0.3em] text-brand-accent mb-6 uppercase opacity-80">01 // Backend Core</span>
          ...
          <p className="text-brand-gray text-[14px] md:text-[15px] font-medium italic border-l-2 border-brand-accent/50 pl-4 py-1">
            "Robust and scalable server-side logic."
          </p>
          <div className="absolute top-10 right-10 w-32 h-32 bg-brand-accent/10 blur-[80px] rounded-full pointer-events-none" />
        </motion.div>
        ...
        {skills.map((skill, i) => (
          <motion.div
            ...
            className={`${skill.className} bento-card group flex flex-col justify-between`}
          >
